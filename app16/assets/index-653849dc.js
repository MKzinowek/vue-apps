...
const _imports_0 = "/app16/pinata.png";
const _imports_1 = "/app16/candy.png";
...
const _sfc_main = {
  ...
  data() {
    return {
      candyOne: "candyOne",
      candyTwo: "candyTwo",
      candyThree: "candyThree",
      candyFour: "candyFour",
      candyFive: "candyFive",
      candySix: "candySix",
      candySeven: "candySeven",
      candyEight: "candyEight"
    };
  },
  methods: {
...
const _hoisted_1 = { id: "score" };
const _hoisted_2 = { id: "pinHolder" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("h1", { id: "title" }, "Every Party Needs A Pinata!", -1);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    createBaseVNode("div", _hoisted_1, toDisplayString(_ctx.counter), 1),
    ...
    createBaseVNode("div", null, [
      createVNode(TransitionGroup, null, {
        default: withCtx(() => [
          $data.showP ? (openBlock(), createElementBlock("img", {
            key: 0,
            class: "candy",
            id: "candy1",
            src: _imports_1
      ...
      createVNode(Transition, null, {
        default: withCtx(() => [
          $data.showP ? (openBlock(), createElementBlock("button", {
            key: 0,
            onClick: _cache[1] || (_cache[1] = ($event) => $data.showP = !$data.showP)
          }, " Grab them!")) : createCommentVNode("", true)
        ]),
        _: 1
      })
    ])
