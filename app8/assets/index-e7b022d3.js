...
const _hoisted_16 = { id: "fig2" };
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("canvas", { id: "preview-canvas" }, null, -1);
  ...
  setup(__props) {
    ...
    function componentUpdate(elm) {
      ...
      if (numErrorRef.value != null && elm.value.length != 10) {
        ...
        numErrorRef.value.innerHTML = validNum.value ? "&nbsp;" : "Minimum length: 8 characters";
      }
    }
    watch(username, () => {
    ...
    watch(number, () => {
      ...
      numErrorRef.value.innerHTML = validNum.value ? "&nbsp;" : "Must be a valid phone number";
    });
          ...
          createBaseVNode("fieldset", _hoisted_3, [
            ...
            createBaseVNode("div", null, [
              createBaseVNode("input", {
                ...
                onChange: _cache[5] || (_cache[5] = ($event) => loadPreviewCanvas($event))
              }, null, 32),
              createBaseVNode("div", _hoisted_15, [
                createBaseVNode("figure", _hoisted_16, [
                  _hoisted_17,
                  createBaseVNode("figcaption", null, toDisplayString(unref(profPic)), 1)
                ])
              ]),
