...
const useuserInfoStore = defineStore("counter", () => {
...
const _hoisted_1 = { id: "linkHolder" };
const _sfc_main$1 = {
  __name: "navBar",
  setup(__props) {
    return (_ctx, _cache) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", null, [
        ...
        createBaseVNode("p", null, "User: " + toDisplayString(unref(store).fname) + " " + toDisplayString(unref(store).lname), 1),
        createBaseVNode("p", null, "Street: " + toDisplayString(unref(store).stAddr), 1),
        ...
        createBaseVNode("p", null, "Zip: " + toDisplayString(unref(store).zipCode), 1)
      ]);
    };
  }
};
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/Edit",
      name: "Edit",
      component: () => __vitePreload(() => import("./Edit-13bc4cda.js"), true ? [] : void 0)
    }
  ]
});
const main = "";
